...
<body>
			...
			<div class="tab-content" style="margin-top: 1px;">
				<div class="tab-pane fade" id="friend" style="position:relative;height: 100%;width: 100%;">
					<div class="input-group">
			            ...
			            <span class="input-group-addon" id="findOneId"><img src="/img/ok.png" width="20px;"></span>
			        </div>
				</div>
				<div class="tab-pane fade" id="home" style="position:relative;height: 100%;width: 100%;">
					<div class="input-group">
			            ...
			            <span class="input-group-addon" id="findFiveId"><img src="/img/ok.png" width="20px;"></span>
			        </div>
				</div>
			</div>
		</div>
    ...
    <script src="/js/publicControl.js"></script>
    <script src="/js/oneControl.js"></script>
    <script src="/js/fiveControl.js"></script>
</body>
</html>
